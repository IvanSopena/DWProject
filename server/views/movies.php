...
<section id="iq-upcoming-movie">
                ...
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">COMEDIA</h4>
            ...
            $datos = $modelo->carga_por_categoria(1);
...
<section id="iq-upcoming-movie">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">ROMANTICAS</h4>
                        </div>
                        <div class="upcoming-contens">
                            <ul class="favorites-slider list-inline row p-0 mb-0">
                                <?php 
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(2);
...
<section id="iq-upcoming-movie">
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(3);
...
<section id="iq-upcoming-movie">
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(4);
...
<section id="iq-upcoming-movie">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">INFANTIL</h4>
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(5);
...
<section id="iq-upcoming-movie">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">FANTASIA</h4>
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(6);
...
<section id="iq-upcoming-movie">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">THILLER</h4>
                        </div>
                        <div class="upcoming-contens">
                            <ul class="favorites-slider list-inline row p-0 mb-0">
                                <?php 
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(7);
...
<section id="iq-upcoming-movie">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">DOCUMENTALES</h4>
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(8);
...
<section id="iq-upcoming-movie">
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(10);
...
<section id="iq-upcoming-movie">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title">CIENCIA FICCIÓN</h4>
            ...
            $modelo = new ActionUsers();
            $datos = $modelo->carga_por_categoria(11);
